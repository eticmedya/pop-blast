...
Yapay Zeka Ogreniyorum | Aykut Uces | x.com/aykutuces
"""
...
class Doc:
    ...
    def _header(self):
        ...
        title="Yapay Zeka Ogreniyorum  |  x.com/aykutuces"
    ...
    def _footer(self):
        ...
        self._fill(*NAVY)
        self._txy("Yapay Zeka Ogreniyorum  |  Aykut Uces  |  x.com/aykutuces",
                  'reg',7.5, ML, fy)
